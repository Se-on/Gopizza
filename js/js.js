$(document).ready(function(){
  ...
  //슬라이드 배치
  //각각 할일이 있고, each-매개변수는 각각의 indx 번호를 사용할 수 있음(요소검사에서 배치 확인)
  slideIndicator.each(function(idx){
  ...
  function moveSlide(i){
    if(currentIdx === i) return; // 현재 0번인데 새로 클릭한게 0번이면 같으므로 아무것도 실행하지 않고 나감(return문 아래 문장은 실행하지 않고 나감)
